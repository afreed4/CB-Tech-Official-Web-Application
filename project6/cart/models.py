...
class Category(models.Model):
    ...
    class Meta:
        verbose_name:str = 'Catagory'
        verbose_name_plural:str = 'Catagories'
...
class Product(models.Model):
    ...
    primary_category=models.ForeignKey(to=Category, on_delete=models.CASCADE,related_name='primary_products',blank=True, null=True)
...
class Order(models.Model):
    ...
    billing_address=models.ForeignKey(to=Address, on_delete=models.SET_NULL, related_name='billing_address', blank=True, null=True)
    shipping_address=models.ForeignKey(to=Address, on_delete=models.SET_NULL, related_name='shipping_address', blank=True, null=True)
    ...
    def get_raw_subtotel(self) -> float:
        total=0
    ...
    def get_subtotal(self) -> str:
        subtotal=self.get_raw_subtotel()
...
class Payment(models.Model):
    ...
    payment_methode=models.CharField(max_length=20, choices=PAYMENT_METHODS,)
...
class StripePayment(models.Model):
    ...
    timestamp=models.DateField(auto_now_add=True)
    order=models.ForeignKey(to=Order, on_delete=models.CASCADE, related_name='stripe_payments')
